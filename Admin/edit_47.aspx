...
private void Page_Load(object sender, System.EventArgs e)
{
	...
	dtable = "gmis_Mo_47";
    filter = " Mocode=" + id;
    flds = new string[] { "fld_47_1" ,"creatorcode"};
    mflds = new string[] { "名称|fld_47_1" };
    types = "01";
    if (!IsPostBack) {//先绑定列表
...
<table width="100%"  border="0" cellpadding="3" cellspacing="1" class="table_graybgcolor" >
	<tr>
	    ...
	    <td  class="td_viewcontent_content" width="35%"><input id="fld_47_1" style="width:95%;" class="boxbline" type="text" runat="server" /></td>
