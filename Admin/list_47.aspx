...
<script runat="server" language="C#">
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        list.SqlStr = "select  '" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode,"+navindex+",fld_47_1,'&nbsp;' btnstr from gmis_mo_47 order by mocode desc";
            ...
            <G:Template id="listtemp1" runat="server">
                <tr class="tr_listcontent">
                    <td class="tdpadd-LR-3">
                        <a href="view_47.aspx?aid=*&mid=*&id=*&navindex=*" title="查看明细">*&nbsp;</a></td>
