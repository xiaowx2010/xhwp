...
private void Page_Load(object sender, System.EventArgs e)
{
   ...
   if (dt.Rows.Count > 0)
   {
       dt.Rows[0]["watchdate1"] = dt.Rows[0]["fld_840_4"].ToString() + "年" + dt.Rows[0]["fld_840_5"].ToString() + "月" == "0年0月" ? "" : dt.Rows[0]["fld_840_4"].ToString() + "年" + dt.Rows[0]["fld_840_5"].ToString() + "月";
       dt.Rows[0]["watchdate2"] = dt.Rows[0]["fld_840_36"].ToString() + "年" + dt.Rows[0]["fld_840_37"].ToString() + "月" == "0年0月" ? "" : dt.Rows[0]["fld_840_36"].ToString() + "年" + dt.Rows[0]["fld_840_37"].ToString() + "月";
       dt.Rows[0]["watchdate3"] = dt.Rows[0]["fld_840_68"].ToString() + "年" + dt.Rows[0]["fld_840_69"].ToString() + "月" == "0年0月" ? "" : dt.Rows[0]["fld_840_68"].ToString() + "年" + dt.Rows[0]["fld_840_69"].ToString() + "月";
       dt.Rows[0]["watchdate4"] = dt.Rows[0]["fld_840_100"].ToString() + "年" + dt.Rows[0]["fld_840_101"].ToString() + "月" == "0年0月" ? "" : dt.Rows[0]["fld_840_100"].ToString() + "年" + dt.Rows[0]["fld_840_101"].ToString() + "月";
