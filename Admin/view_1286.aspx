...
private void Page_Load(object sender, System.EventArgs e)
{
	...
	for(int i=3;i<123;)
	{
		if(i!=6)
		{
			h_viewstr.Append("fld_1303_"+i+",");
		}
		else if(i==7||i==20||i==36||i==49||i==65||i==78||i==94||i==107||i==13)
		{
			h_viewstr.Append("cast(fld_1303_"+i+" as char(8))+'年'+cast(fld_1303_"+(i+1)+" as char(2))+'月',");
			i++;
		}
		switch(i)
		{
	...
	h_viewstr.Append(" '' as kong from gmis_mo_1303 where fld_1303_1='"+orgcode+"'");
