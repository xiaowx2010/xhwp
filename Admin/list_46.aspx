...
<script runat="server" language="C#">
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        string tablename = "gmis_mo_46";//数据表名称
        string orderstr = " order by mocode";//排序条件;
        //设置列表控件显示行数
        list.Rows = pagesize;
        //设置列表控件数据源
        list.SqlStr = "declare @allcount int;select @allcount=count(1) from " + tablename + " where 1=1;select @allcount as allcount,'" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode," + navindex + ",fld_46_1,'' as btnstr from " + tablename + " where mocode in (select top " + (fromcount + pagesize) + " mocode from " + tablename + " where 1=1 " + orderstr + ") and mocode not in (select top " + fromcount + " mocode from " + tablename + " where 1=1 " + orderstr + " ) " + orderstr + " ";
        ...
        <G:ListTable ID="list" Rows="20" IsProPage="true" runat="server">
            ...
            <G:Template id="listtemp1" runat="server">
                <tr class="tr_listcontent">
                    ...
                    <td class="tdpadd-LR-3"><a href="view_46.aspx?aid=*&mid=*&id=*&navindex=*" title="查看明细">*&nbsp;</a></td>
                    <td class="tdpadd-icon"  align="center">*&nbsp;</td>
                </tr>
            </G:Template>
