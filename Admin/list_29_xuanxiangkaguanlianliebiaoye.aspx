...
private void Page_Load(object sender, System.EventArgs e)
{
    ...
    list.SqlStr = "select  '" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode," + navindex + ",fld_29_5,fld_29_1,fld_29_2,'&nbsp;' as btnstr from gmis_mo_29 where fld_29_5='" + orgcode + "' order by mocode desc";
    //Response.Write(list.SqlStr);
    //Response.Write("select  '" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode," + navindex + ",fld_29_1,fld_29_2,fld_29_3,fld_29_4,'&nbsp;' as btnstr from gmis_mo_29 order by mocode asc");

    list.Rows = GetListRows();
    SetSESSION("extinfo", "29");
...
<G:ListTable ID="list" Rows="20" IsProPage=true runat="server">
	...
	<G:Template id="listtemp1" runat="server">
		<tr class="tr_listcontent">
			<td><a href="view_29.aspx?aid=*&mid=*&id=*&navindex=*" title="查看明细">*&nbsp;</a></td>
			<td>*</td>
			<td>*</td>
			<td align="center">*</td>
		</tr>
