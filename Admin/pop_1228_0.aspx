...
function BindList()
{
	...
	if (opener.form1.fld_1228_4.value != "")
	{
		var args = opener.form1.fld_1228_4.value.split('|');
		if (args.length>0)
		{
...
function Click_OK()
{
	...
	opener.form1.fld_1228_4.value = backstr.substring(1);
...
function ShowHead()
{
	...
	document.getElementById("fld_1228_4").value = backstr.substring(1);
	if (document.getElementById("fld_1228_4").value == "")
	{
		alert('请先设置显示字段！');
	}
	else 
	{
		window.open('pop_1228_2.aspx?field='+document.getElementById("fld_1228_4").value);
	}
}
</script>
