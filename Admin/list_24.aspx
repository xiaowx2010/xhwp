...
{	
	...
	string h_tablename = "gmis_mo_24 a left outer join gmis_mo_23 b on a.fld_24_1=b.fld_23_1";//数据表名称
	...
	al.Add(new string[] { "单位名称", "25%", "fld_23_4" });
	al.Add(new string[] { "单位代码", "18%", "fld_24_8" });
	al.Add(new string[] { "排放口代码", "18%", "fld_24_1" });
	al.Add(new string[] { "废气排放浓度", "16%", "fld_24_7" });
	al.Add(new string[] { "监测日期", "15%", "fld_24_3" });
