...
private void Page_Load(object sender, System.EventArgs e)
{
    ...
    string str1=",fld_1350_3,''as watchdate1,'' as orgdata1";
    for(int i=7;i<132;i++)
    {
        str1+=",fld_1350_"+i+"";
        if(i==17)
   ...
   view.SqlStr="select (select fld_1347_2 from gmis_mo_1347 where fld_1347_1=fld_1349_1),(select fld_1347_4 from gmis_mo_1347 where fld_1347_1=fld_1349_1) "+str1+",fld_1349_19,fld_1349_2,fld_1349_3,fld_1349_4,fld_1349_5,fld_1349_6,fld_1350_4,fld_1350_5,fld_1350_36,fld_1350_37,fld_1350_68,fld_1350_69,fld_1350_100,fld_1350_101,fld_1350_6,(select fld_1038_2 from gmis_mo_1038 where fld_1038_1=fld_1350_6) as fld_1350_6_1,fld_1350_38,(select fld_1038_2 from gmis_mo_1038 where fld_1038_1=fld_1350_38) as fld_1350_38_1,fld_1350_70,(select fld_1038_2 from gmis_mo_1038 where fld_1038_1=fld_1350_70) as fld_1350_70_1,fld_1350_102,(select fld_1038_2 from gmis_mo_1038 where fld_1038_1=fld_1350_102) as fld_1350_102_1,fld_1349_1 from gmis_mo_1349 a left outer join gmis_mo_1350 b on a.fld_1349_1=b.fld_1350_1 where fld_1349_1='"+orgcode+"'";
   DataTable dt=view.DataTable;
   if (dt.Rows.Count > 0)
   {
       dt.Rows[0]["watchdate1"] = dt.Rows[0]["fld_1350_4"].ToString() + "年" + dt.Rows[0]["fld_1350_5"].ToString() + "月" == "0年0月" ? "" : dt.Rows[0]["fld_1350_4"].ToString() + "年" + dt.Rows[0]["fld_1350_5"].ToString() + "月";
       dt.Rows[0]["watchdate2"] = dt.Rows[0]["fld_1350_36"].ToString() + "年" + dt.Rows[0]["fld_1350_37"].ToString() + "月" == "0年0月" ? "" : dt.Rows[0]["fld_1350_36"].ToString() + "年" + dt.Rows[0]["fld_1350_37"].ToString() + "月";
       dt.Rows[0]["watchdate3"] = dt.Rows[0]["fld_1350_68"].ToString() + "年" + dt.Rows[0]["fld_1350_69"].ToString() + "月" == "0年0月" ? "" : dt.Rows[0]["fld_1350_68"].ToString() + "年" + dt.Rows[0]["fld_1350_69"].ToString() + "月";
       dt.Rows[0]["watchdate4"] = dt.Rows[0]["fld_1350_100"].ToString() + "年" + dt.Rows[0]["fld_1350_101"].ToString() + "月" == "0年0月" ? "" : dt.Rows[0]["fld_1350_100"].ToString() + "年" + dt.Rows[0]["fld_1350_101"].ToString() + "月";
       dt.Rows[0]["orgdata1"] = dt.Rows[0]["fld_1350_6"].ToString() + "=" + dt.Rows[0]["fld_1350_6_1"].ToString() == "=" ? "" : dt.Rows[0]["fld_1350_6"].ToString() + "=" + dt.Rows[0]["fld_1350_6_1"].ToString();
       dt.Rows[0]["orgdata2"] = dt.Rows[0]["fld_1350_38"].ToString() + "=" + dt.Rows[0]["fld_1350_38_1"].ToString() == "=" ? "" : dt.Rows[0]["fld_1350_38"].ToString() + "=" + dt.Rows[0]["fld_1350_38_1"].ToString();
       dt.Rows[0]["orgdata3"] = dt.Rows[0]["fld_1350_70"].ToString() + "=" + dt.Rows[0]["fld_1350_70_1"].ToString() == "=" ? "" : dt.Rows[0]["fld_1350_70"].ToString() + "=" + dt.Rows[0]["fld_1350_70_1"].ToString();
       dt.Rows[0]["orgdata4"] = dt.Rows[0]["fld_1350_102"].ToString() + "=" + dt.Rows[0]["fld_1350_102_1"].ToString() == "=" ? "" : dt.Rows[0]["fld_1350_102"].ToString() + "=" + dt.Rows[0]["fld_1350_102_1"].ToString();
   }
