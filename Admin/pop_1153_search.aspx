...
<script language="C#" runat="server">
    private void Page_Load(object sender, System.EventArgs e)
    {
      ...
      //Response.Expires = -1;
        ...
        list.SqlStr = "select fld_1153_2,min(fld_1153_16),min(fld_1153_1),'' as btnstr,min(mocode) as minmocode from " + GetModuleTableName("1153") + " where fld_1153_1='" + h_year + "' and fld_1153_2 like '%" + h_key + "%' group by fld_1153_2";
    ...
    public override void BeforeOutput(DataTable dt, int rowi)
    {
        ...
        //db.SqlString = "select top 1 mocode from " + GetModuleTableName("1153") + " where fld_1153_2='" + dr["fld_1153_2"].ToString() + "'";

        //dr["btnstr"] += "<a href=\"javascript:chooseOne('" + mid + "','" + db.GetDataTable().Rows[0][0].ToString() + "','" + StringUtility.StringToBase64("edit") + "');\"><img src=\"images/icons/selectall.gif\" title=\"确认\" align=\"absmiddle\" border=\"0\"></a>";
