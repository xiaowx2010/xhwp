...
{    
	...
	if(!IsPostBack)
	{
        ...
        sel_month.Items.Clear();
        for (int i = 1; i < 13; i++)
        {
            sel_month.Items.Add(i.ToString());
        }
	}
    if (sel_year.SelectedItem != null && sel_month.SelectedItem != null)
            sel_date.Value = sel_year.SelectedItem.Value + "-" + sel_month.SelectedItem.Value;
	BindDataList();//绑定
    ...
    <!--#include file="toolbarleft.aspx"--> 
			<!--右边固定按钮-->
			    <td id="tb_sel" runat="server" nowrap>
			       <asp:DropDownList ID="sel_year" runat="server"></asp:DropDownList>年 &nbsp; <asp:DropDownList ID="sel_month" runat="server" AutoPostBack="true"></asp:DropDownList>月
			    </td>
			<!--右边固定按钮-->
