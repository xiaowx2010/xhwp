...
private void Page_Load(object sender, System.EventArgs e)
{
    ...
    if (orgcode != "0")
    {
       ...
       list.SqlStr = "select fld_66_7,fld_66_1,fld_66_2,convert(varchar(10),fld_66_3,120),convert(varchar(10),fld_66_4,120),fld_66_5,fld_66_6 from gmis_mo_66 where 1=1 " + filter;
...
<G:Template id="tempview" runat="server">
    ...
    <tr valign="middle" class="zy_bold_lineX" align="left" height="22">
	  <td width="8%">单位代码：</td>
	     <td width="17%" >*&nbsp;</td>
	   <td width="8%">处理单位名称：</td>
	    <td width="17%" >*&nbsp;</td>
	   <td width="8%">案由：</td>
	    <td width="20%"  colspan=3>*&nbsp;</td>
    </tr>
    <tr valign="middle"  align="left" height="22">   
	   <td width="10%">限期治理起始日期：</td>
	    <td>*&nbsp;</td>	   
	    <td width="10%">限期治理截至日期：</td>
	    <td>*&nbsp;</td>
		<td width="8%">实施要求：</td>
	    <td>*&nbsp;</td> 
		<td width="8%">核查情况：</td>
