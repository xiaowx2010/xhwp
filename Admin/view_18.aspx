...
private void Page_Load(object sender, System.EventArgs e)
{
	...
	DataTable h_wrwdt = db.GetDataTable(db.ConnStr,"select mocode,(select fld_1205_1 from gmis_mo_1205 where mocode = fld_21_2) as wrwname from gmis_mo_21 where fld_21_3=(select fld_18_8 from gmis_mo_18 where mocode="+id+")");//获取所有注册已处理污染物
