...
private void Page_Load(object sender, System.EventArgs e)
{
	...
	h_viewstr.Append("select top 2 fld_702_2+'='+(select fld_1038_2 from gmis_mo_1038 where fld_1038_1=fld_702_2)");
	for(int i=4;i<37;i++)
	{
		if(i==6||i==13)
		{
			h_viewstr.Append(",cast(fld_702_"+i+" as char(8))+'年'+cast(fld_702_"+(i+1)+" as char(2))+'月'");
			i++;
		}
		else
		h_viewstr.Append(",fld_702_"+i);
	}
	h_viewstr.Append(" from gmis_mo_702 left join gmis_mo_" + mid + " on fld_702_1=fld_699_1 where fld_699_1='"+orgcode+"'");
	list_top.SqlStr = h_viewstr.ToString();
	
	DataTable h_dt = list_top.DataTable;
	list_bottom.DataTable= h_dt;
	
	db.SqlString="select fld_"+mid+"_18,fld_"+mid+"_2,fld_"+mid+"_3,((case when fld_" + mid + "_4<10 then '200'+cast(fld_" + mid + "_4 as char(4)) else cast(fld_" + mid + "_4 as char(4)) end)+'年 '+(case when fld_" + mid + "_5<10 then '0'+cast(fld_" + mid + "_5 as char(1)) else cast(fld_" + mid + "_5 as char(2)) end)+' 月 '+(case when fld_" + mid + "_6<10 then '0'+cast(fld_" + mid + "_6 as char(1)) else cast(fld_" + mid + "_6 as char(2)) end)+' 日') as ctbrq,(select top 1 fld_1202_1 from gmis_mo_1202 where fld_1202_2=fld_" + mid + "_1) as c_name,fld_" + mid + "_1 from gmis_mo_" + mid + " where fld_699_1='"+orgcode+"'";     
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px; ">
  <tr>
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="font1220_000000">表　　号：G109-2表</td>
      </tr>
      <tr>
