...
public override void BeforeOutput(DataTable dt, int rowi)
{
    ...
    dr["btnstr"] += "<a href=\"javascript:chooseOne('" + mid + "','" + StringUtility.StringToBase64(dr["mocode"].ToString()) + "','" + StringUtility.StringToBase64("edit") + "');\"><img src=\"images/icons/selectall.gif\" title=\"确认\" align=\"absmiddle\" border=\"0\"></a>";
}
...
{
   opener.window.location.href="getpage.aspx?aid="+arg3+"&mid="+arg1+"&pid="+arg2+"";
   closeThis();
}
