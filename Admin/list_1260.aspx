...
<script runat="server" language="C#">
    string sortid, sortdir,p_field,p_key,p_type,p_date,p_month,p_area;
    private void Page_Load(object sender, System.EventArgs e)
    {
       ...
       // p_field = GetQueryString("fid", "");  //所选择字段
		...
		p_area = GetPageParameter("select_area","0");
        ...
        if(!IsPostBack)
        {
            ...
            BindListControl(select_area,"fld_1260_52","fld_1260_52","select distinct fld_1260_52  from gmis_mo_1260","---------");
    ...
    private void BindListData()
    {
        ...
        if (fsb.Length > 0 )
        {
			...
			if(guangye.GetControlValue(select_area)!="0")
                h_fstr+= " and fld_1260_52 = '"+guangye.GetControlValue(select_area)+"' ";
	...
	private void SetSessionFilter()
	{
		...
		SetPageParameter("select_area",guangye.GetControlValue(select_area));
	}
...
<body style="padding: 10px; text-align: center">
    ...
    <td nowrap style="padding-left: 10px;">
        审批单位：<asp:DropDownList ID="select_area" runat="server" OnSelectedIndexChanged="Change_Type"  style="width: 120px;">
        </asp:DropDownList>
    </td>
    <td nowrap style="padding-left: 10px;">
