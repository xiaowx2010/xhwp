...
{      
	...
	if (GetSESSION("filter")!="")
	{
		...
		if (h_keystr.Length>4)
		{
			guangye.SetControlValue(fld_1228_2,h_keystr[0]);
			guangye.SetControlValue(fld_1228_3,h_keystr[1]);
			guangye.SetControlValue(fld_1228_4,h_keystr[2]);
			guangye.SetControlValue(fld_1228_5,h_keystr[3]);
			guangye.SetControlValue(fld_1228_6,h_keystr[4]);
		}
		SetSESSION("filter","");
	}
	BindListData();
...
{	
	...
	if (guangye.GetControlValue(fld_1228_4)!="")
	{
		...
		if (h_v0.Length>0)
		{
			h_table = "gmis_mo_"+guangye.GetControlValue(fld_1228_5);
		...
		//排序
		if (guangye.GetControlValue(fld_1228_3)!="")
		{
			string[] h_o0 = guangye.GetControlValue(fld_1228_3).Trim('|').Split('|');
			if (h_o0.Length>0)
			{
				h_order = " order by ";
		...
		//条件
		if (guangye.GetControlValue(fld_1228_2)=="")
		{
			fld_1228_2.Value=StringUtility.StringToBase64(CheckSearchFilter(guangye.GetControlValue(fld_1228_6)));//获取查询条件
		}
		h_where = (guangye.GetControlValue(fld_1228_2)=="")?"":" where "+StringUtility.Base64ToString(guangye.GetControlValue(fld_1228_2));
