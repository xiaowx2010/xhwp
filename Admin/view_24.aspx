...
private void Page_Load(object sender, System.EventArgs e)
{
    ...
    if (orgcode != "0")
    {
        filter = " and fld_24_8='" + orgcode + "'";
        db.SqlString = "select mocode from gmis_mo_24 where 1=1 " + filter ;
    ...
    view.SqlStr = "select fld_23_3,fld_23_4,fld_23_1,fld_23_2,'' as wrw,Convert(nvarchar(10),fld_24_3,120),fld_24_4,fld_24_7,fld_24_9,fld_24_10,fld_23_11 from gmis_mo_24 left outer join gmis_mo_23 on fld_24_8=fld_23_3 and fld_24_1=fld_23_1 where gmis_mo_24.mocode=" + id;
    if (id!="0"&&view.DataTable != null && view.DataTable.Rows.Count > 0)
    {
        iframe_17.Attributes["src"] = "iframe_658.aspx?aid=" + StringUtility.StringToBase64(aid) + "&mid=" + mid + "&orgcode=" + StringUtility.StringToBase64(view.DataTable.Rows[0]["fld_23_3"].ToString()) + "&fcode=" + h_fcode;
    }else
	...
	DataTable h_wrwdt = db.GetDataTable(db.ConnStr,"select mocode,(select fld_1206_1 from gmis_mo_1206 where mocode = fld_29_2) as wrwname from gmis_mo_29 where fld_29_3=(select fld_24_8 from gmis_mo_24 where mocode="+id+")");//获取所有注册已处理污染物
...
<table width="100%" border="0" cellpadding="1" cellspacing="1" class="table_graybgcolor_Top" style="margin-top: 10px;"> 
	...
	<tr>
		<td width="100" align="right" class="td_viewcontent_title">废气排放浓度:</td>
		<td class="td_viewcontent_content" style="width: 35%">*&nbsp;</td>
		<td width="100" align="right" class="td_viewcontent_title">林格曼黑度:</td>
		<td class="td_viewcontent_content" style="width: 35%">*&nbsp;</td>
	</tr>
	<tr>
		<td width="100" align="right" class="td_viewcontent_title">废气排放速率:</td>
		<td class="td_viewcontent_content" style="width: 35%">*&nbsp;</td>
