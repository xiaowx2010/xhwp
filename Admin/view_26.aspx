...
private void Page_Load(object sender, System.EventArgs e)
{
    ...
    view.SqlStr = "select fld_26_6,fld_26_1,fld_26_2,fld_26_3,fld_26_4,fld_26_5,fld_26_6 from gmis_mo_26 where 1=1 " + filter;
    if (id!="0"&&view.DataTable != null && view.DataTable.Rows.Count > 0)
    {
        iframe_17.Attributes["src"] = "iframe_658.aspx?aid=" + StringUtility.StringToBase64(aid) + "&mid=" + mid + "&orgcode=" + StringUtility.StringToBase64(view.DataTable.Rows[0]["fld_26_6"].ToString()) + "&fcode=" + h_fcode;
    }else
...
<table width="100%"  border="0" cellpadding="3" cellspacing="1" class="table_graybgcolor">
    <tr>
	    ...
	    <td align="right"  class="td_viewcontent_title">名称：</td>
	    <td class="td_viewcontent_content" width="35%">*&nbsp;</td>
    </tr>
    <tr>
