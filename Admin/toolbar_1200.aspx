...
//{
    ...
    //{
    //    SetSESSION("alert", GetSESSION("alert") + "直属上级不能为空！");
    //}
...
//}
    ...
    <td nowrap style="padding-left:5px;" id="td_btn_up" runat="server"><G:Button id="btn_up" type="toolbar" mode="on" text="同级内上移" onclick="Click_Toolbar" runat="server"></G:Button></td>
    <td nowrap style="padding-left:5px;" id="td_btn_down" runat="server"><G:Button id="btn_down" type="toolbar" mode="on" text="同级内下移" onclick="Click_Toolbar" runat="server"></G:Button></td>
    <td width="100%" nowrap style="padding-left:5px;"><span id="alertmiddle" runat="server" style="color:Red;"></span></td>
    <td nowrap style="padding-right:5px;" id="td_btn_backlist" runat="server"><G:Button id="btn_backlist" type="toolbar" icon="tb13"  mode="on" text="返回列表" onclick="Click_Toolbar" runat="server"></G:Button></td>
    <td nowrap style="padding-right:5px;" id="td_btn_newson" runat="server"><G:Button id="btn_newson" type="toolbar" icon="tb01"  mode="on" text="新增" onclick="Click_Toolbar" runat="server"></G:Button></td>
    <td nowrap style="padding-right:5px;" id="td_btn_newsubson" runat="server"><G:Button id="btn_newsubson" type="toolbar" icon="tb01"  mode="on" text="新增子项" onclick="Click_Toolbar" runat="server"></G:Button></td>
    <td id="tb_btn_clear" visible="false" runat="server" style="padding-right:5px;width:55px;" nowrap><G:Button id="btn_clear" type="toolbar" mode="on" icon="tb06" text="清空" onclick="Click_Toolbar" runat="server"></G:Button></td>
    <td nowrap style="padding-right:5px;" id="td_btn_deleteson" runat="server"><G:Button id="btn_deleteson" type="toolbar" icon="tb06"  mode="on" text="删除" onclick="Click_Toolbar" runat="server"></G:Button></td>
    <td nowrap style="padding-right:5px;" id="td_btn_saveson" runat="server"><G:Button id="btn_saveson" type="toolbar" icon="tb05"  mode="on" text="保存" onclick="Click_Toolbar" runat="server"></G:Button></td>
