...
private void Page_Load(object sender, System.EventArgs e)
{
    ...
    if (orgcode != "0")
    {
        list.SqlStr = "select fld_53_1,fld_53_2,(select fld_54_1 from gmis_mo_54 where mocode=fld_53_6),fld_53_5,(select fld_1165_2 from gmis_mo_1165 where mocode=fld_53_7),(select fld_1196_1 from gmis_mo_1196 where mocode=fld_53_10),fld_53_8,case fld_53_9 when 0 then '否' else '是' end,'' as wrw,fld_53_11,mocode from gmis_mo_53  where fld_53_3='"+orgcode+"' order by fld_53_1 asc";
		
		//设置列表控件显示行数
		list.Rows = (list.DataTable.Rows.Count < 8) ? 8 : list.DataTable.Rows.Count;

		DataTable h_wrwdt = db.GetDataTable(db.ConnStr,"select mocode,(select fld_1205_1 from gmis_mo_1205 where mocode = fld_21_2) as wrwname from gmis_mo_21 where fld_21_3='"+orgcode+"'");//获取所有注册已处理污染物
