...
private void Page_Load(object sender, System.EventArgs e)
{
	...
	h_viewstr.Append("select top 2 fld_1421_2+'='+(select fld_1038_2 from gmis_mo_1038 where fld_1038_1=fld_1421_2)");
	for(int i=4;i<37;i++)
	{
		if(i==6||i==13)
		{
			h_viewstr.Append(",cast(fld_1421_"+i+" as char(8))+'年'+cast(fld_1421_"+(i+1)+" as char(2))+'月'");
			i++;
		}
		else
		h_viewstr.Append(",fld_1421_"+i);
	}
	h_viewstr.Append(" from gmis_mo_1421 left join gmis_mo_" + mid + " on fld_1421_1=fld_1409_1 where fld_1409_1='"+orgcode+"'");
	list_top.SqlStr = h_viewstr.ToString();

	DataTable h_dt = list_top.DataTable;
	list_bottom.DataTable= h_dt;

	db.SqlString="select fld_"+mid+"_18,fld_"+mid+"_2,fld_"+mid+"_3,((case when fld_" + mid + "_4<10 then '201'+cast(fld_" + mid + "_4 as char(4)) else cast(fld_" + mid + "_4 as char(4)) end)+'年 '+(case when fld_" + mid + "_5<10 then '0'+cast(fld_" + mid + "_5 as char(1)) else cast(fld_" + mid + "_5 as char(2)) end)+' 月 '+(case when fld_" + mid + "_6<10 then '0'+cast(fld_" + mid + "_6 as char(1)) else cast(fld_" + mid + "_6 as char(2)) end)+' 日') as ctbrq,(select fld_1396_2 from gmis_mo_1396 where fld_1396_1=fld_1409_1) as c_name,(select fld_1396_4 from gmis_mo_1396 where fld_1396_1=fld_1409_1) as fld_" + mid + "_1 from gmis_mo_" + mid + " where fld_1409_1='"+orgcode+"'";
