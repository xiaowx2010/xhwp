...
{   
    Response.Redirect("getpage.aspx?aid="+StringUtility.StringToBase64("list")+"&mid="+mid+"&tid="+tid+"&pid="+pid);
}
//验证输入字段类型
...
<td id="tb_2_new" visible="false" runat="server"  style="padding-left:5px;width:55px;" nowrap>
            <G:Button id="btn_newadd_new" type="toolbar" mode="on" icon="tb01" text="重新新增"  onclick="Click_NewAdd"  runat="server"></G:Button>
            </td>
