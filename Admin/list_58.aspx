...
{   
	...
	{
		h_fstr += " and fld_58_3 = "+guangye.GetControlValue(select_year)+"";
	}

	//添加月份筛选条件
	if (guangye.GetControlValue(select_month) != "" && guangye.GetControlValue(select_month) != "0")
	{
		h_fstr += " and fld_58_4 = "+guangye.GetControlValue(select_month)+"";
	}
	
	//添加字段筛选条件
	if (guangye.GetControlValue(key) != "" && guangye.GetControlValue(select_field) != "" && guangye.GetControlValue(select_field) != "0")
	{
		string h_field = (guangye.GetControlValue(select_field)=="1")?"fld_58_2":"(select fld_23_2 from gmis_mo_23 where fld_23_1=fld_58_2)";
		h_fstr += " and "+h_field+" like '%"+guangye.GetControlValue(key)+"%'";
	}

	list.SqlStr = "select  '" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode,fld_58_3,fld_58_4,fld_58_2,'' btnstr from gmis_mo_58 where 1=1 "+h_fstr+" order by fld_58_3 desc,fld_58_4 desc";
...
private void CheckSelect()
{
	...
	Response.Redirect("list_58.aspx?aid=" + StringUtility.StringToBase64("list") + "&mid=" + mid + "&navindex=0");
}
</script>
...
<G:ListTable ID="list" Rows="20" IsProPage=true runat="server">
	...
	<G:NavStyle5 ID="NavStyle" PageUrl="list_58.aspx" runat="server"></G:NavStyle5>
	</G:ListTable> 
<!--动态生成html,结束-->
</form>
</body>
