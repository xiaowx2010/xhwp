...
private void Page_Load(object sender, System.EventArgs e)
{
	...
	h_viewstr.Append("select top 6 fld_1308_3");
	for(int i=4;i<24;i++)
	{
		h_viewstr.Append(",fld_1308_"+i);
	}
	h_viewstr.Append(" from gmis_mo_1308 left join gmis_mo_" + mid + " on fld_1289_1=fld_1308_1 where fld_1289_1='"+orgcode+"'");
	list_top.SqlStr = h_viewstr.ToString();
	
	DataTable h_dt = list_top.DataTable;
	list_bottom.DataTable= h_dt;
	
	db.SqlString="select (select top 1 fld_1202_1 from gmis_mo_1202 where fld_1202_2=fld_" + mid + "_1) as c_name,fld_" + mid + "_1,fld_"+mid+"_18,fld_"+mid+"_2,fld_"+mid+"_3,((case when fld_" + mid + "_4<10 then '201'+cast(fld_" + mid + "_4 as char(4)) else cast(fld_" + mid + "_4 as char(4)) end)+'年 '+(case when fld_" + mid + "_5<10 then '0'+cast(fld_" + mid + "_5 as char(1)) else cast(fld_" + mid + "_5 as char(2)) end)+' 月 '+(case when fld_" + mid + "_6<10 then '0'+cast(fld_" + mid + "_6 as char(1)) else cast(fld_" + mid + "_6 as char(2)) end)+' 日') as ctbrq from gmis_mo_" + mid + " where fld_1289_1='"+orgcode+"'";     
