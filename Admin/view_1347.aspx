...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
    ...
    <table width="100%">
        <tr>
            <td width="30%">&nbsp;</td>
            <td width="40%" align="center" valign="middle" style="font-size:large; font-weight:bolder;">污水处理厂基本情况表<br><span style="font-size:small; font-weight:normal;">2009年</span></td>
            <td width="30%">
                <table width="100%">
