...
<script runat="server" language="C#">
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        list.SqlStr = "select  '" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode," + navindex + ",fld_67_1,Cast(datepart(year,fld_67_2) as varchar(50))+'-'+Case when datepart(month,fld_67_2)<10 then ('0'+Cast(datepart(month,fld_67_2) as varchar(50))) else Cast(datepart(month,fld_67_2) as varchar(50)) end +'-'+Case when datepart(day,fld_67_2)<10 then ('0'+Cast(datepart(day,fld_67_2) as varchar(50))) else Cast(datepart(day,fld_67_2) as varchar(50)) end,'&nbsp;' as btnstr from gmis_mo_67 order by mocode desc";
        list.Rows = GetListRows();
        SetSESSION("extinfo", "67");
        //Response.Write("select  '" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode," + navindex + ",fld_67_1,Cast(datepart(year,fld_67_2) as varchar(50))+'-'+Case when datepart(month,fld_67_2)<10 then ('0'+Cast(datepart(month,fld_67_2) as varchar(50))) else Cast(datepart(month,fld_67_2) as varchar(50)) end +'-'+Case when datepart(day,fld_67_2)<10 then ('0'+Cast(datepart(day,fld_67_2) as varchar(50))) else Cast(datepart(day,fld_67_2) as varchar(50)) end,'&nbsp;' as btnstr from gmis_mo_67 order by mocode desc");
    }
            ...
            <G:Template id="listtemp1" runat="server">
                <tr class="tr_listcontent">
                    <td class="tdpadd-LR-3">
                        <a href="view_67.aspx?aid=*&mid=*&id=*&navindex=*" title="查看明细">*&nbsp;</a></td>
