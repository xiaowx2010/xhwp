...
private void Page_Load(object sender, System.EventArgs e)
{
	...
	dtable = "gmis_Mo_55";
    filter = " Mocode=" + id;
    flds = new string[] { "fld_55_1" ,"creatorcode"};
    mflds = new string[] { "污染物类别|fld_55_1" };
    types = "01";
    if (!IsPostBack) {//先绑定列表
...
<table width="100%"  border="0" cellpadding="3" cellspacing="1" class="table_graybgcolor" >
	<tr>
	    ...
	    <td  width="35%" class="td_viewcontent_content"><input id="fld_55_1" style="width:95%;" class="boxbline" type="text" runat="server" /></td>
