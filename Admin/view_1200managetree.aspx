...
<div id="treearea"></div>
	<script>CreateControl("treearea","tree","images/tree.swf?tid=view_1200&cid=<%=id%>", 550, 400, "#FFFFFF");</script>
    ...
    {
	    if(command == "data"){
		    window.parent.location = "view_1200.aspx?aid=dmlldw==&mid=1200&id="+args;	//
	    }
    }
    //-->
    </script>
