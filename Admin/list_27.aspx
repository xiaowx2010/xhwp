...
<script runat="server" language="C#">
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        list.SqlStr = "select  '" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode," + navindex + ",(select fld_62_1 from gmis_mo_62 where gmis_mo_62.mocode=fld_27_1),fld_27_2,fld_27_3,'&nbsp;' btnstr from gmis_mo_27 order by mocode desc";
        list.Rows = GetListRows();
        SetSESSION("extinfo", "27");
    }
            ...
            <G:Template id="listtemp1" runat="server">
                <tr class="tr_listcontent">
                    <td class="tdpadd-LR-3">
                        <a href="view_27.aspx?aid=*&mid=*&id=*&navindex=*" title="查看明细">*&nbsp;</a></td>
