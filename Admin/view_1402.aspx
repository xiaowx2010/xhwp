...
private void Page_Load(object sender, System.EventArgs e)
{
	...
	for(int i=3;i<123;)
	{
		if(i!=6&&i!=18&&i!=19&&i!=47&&i!=48&&i!=76&&i!=77&&i!=105&&i!=106&&i!=5)
		{
			h_viewstr.Append("fld_1414_"+i+",");
		}
		else if(i==7||i==20||i==36||i==49||i==65||i==78||i==94||i==107||i==13)
		{
			h_viewstr.Append("cast(fld_1414_"+i+" as char(8))+'年'+cast(fld_1414_"+(i+1)+" as char(2))+'月',");
			i++;
		}
		else if (i==5)
		{
            h_viewstr.Append("fld_1414_5+'='+(select fld_1165_2 from gmis_mo_1165 where fld_1165_1=fld_1414_5),");
		}
		else if (i==6)
		{
            h_viewstr.Append("fld_1414_6+'='+(select fld_1035_2 from gmis_mo_1035 where fld_1035_1 = fld_1414_6),");
		}
		switch(i)
		{
			case 19:
	...
	h_viewstr.Append(" '' as kong from gmis_mo_1414 where fld_1414_1='"+orgcode+"'");
//	Response.Write(h_viewstr.ToString());
	...
	db.SqlString="select (select fld_1396_2 from gmis_mo_1396 where fld_1396_1=fld_"+mid+"_1) as c_name,(select fld_1396_4 from gmis_mo_1396 where fld_1396_1=fld_"+mid+"_1) as fld_"+mid+"_1 ,fld_"+mid+"_18,fld_"+mid+"_2,fld_"+mid+"_3,((case when fld_" + mid + "_4<10 then '201'+cast(fld_" + mid + "_4 as char(4)) else cast(fld_" + mid + "_4 as char(4)) end)+'年 '+(case when fld_" + mid + "_5<10 then '0'+cast(fld_" + mid + "_5 as char(1)) else cast(fld_" + mid + "_5 as char(2)) end)+' 月 '+(case when fld_" + mid + "_6<10 then '0'+cast(fld_" + mid + "_6 as char(1)) else cast(fld_" + mid + "_6 as char(2)) end)+' 日') as ctbrq from gmis_mo_" + mid + " where fld_"+mid+"_1='"+orgcode+"'";
