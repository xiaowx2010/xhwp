...
{
    mid = "1241";
    list_1241.SqlStr = "select mocode,fld_1241_1, '' as btnstr from gmis_mo_1241";
    list_1241.Rows = list_1241.DataTable.Rows.Count;
}
...
private void Delete_All(object sender, System.EventArgs e)
{
    ...
    db.SqlString = "delete gmis_mo_1241 where mocode in("+h_listmocode+");delete gmis_mo_1242 where fld_1242_1 in("+h_listmocode+");delete gmis_mo_1243 where fld_1243_6 in("+h_listmocode+")";
    string exeinfo=db.UpdateTable();
    if (exeinfo == "操作成功！")
    {
        Response.Redirect("pop_1241_3.aspx"); 
    }
}    
</script>
<body >
<form id="form1" runat="server"><input id="checkedlist" runat="server" type="hidden"/>
    <!--选项卡-->
        ...
        <!--操作工具条-->
<G:listtable id="list_1241" runat="server" showallline="false" IsProPage="true">
