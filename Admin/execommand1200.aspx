...
{
    //Response.Write(UpdateTypeIndex("gmis_mo_1200", "mocode", "fld_1200_3", "fld_1200_6", "fld_1200_5", "fld_1200_4"));
    Response.Write(guangye.ExeBySql(UpdateTypeIndex("gmis_mo_1200", "mocode", "fld_1200_3", "fld_1200_6", "fld_1200_5", "fld_1200_4"), 1));
    //db.SqlString = "select fld_1200_8 from gmis_mo_1200 where  mocode>576";
    //foreach (DataRow dr in db.GetDataTable().Rows)
    //{
    //    Response.Write("update gmis_mo_1200 set fld_1200_4=(select mocode from gmis_mo_1200 b where b.fld_1200_8 = substring('" + dr["fld_1200_8"] + "',0,3)) where fld_1200_8='" + dr["fld_1200_8"] + "' ;");
    //}
}
