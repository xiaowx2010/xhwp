...
{   
	...
	{
		h_fstr += " and fld_20_2 = "+guangye.GetControlValue(select_year)+"";
	}

	//添加字段筛选条件
	if (guangye.GetControlValue(key) != "" && guangye.GetControlValue(select_field) != "" && guangye.GetControlValue(select_field) != "0")
	{
		string h_field = (guangye.GetControlValue(select_field)=="1")?"fld_20_1":"(select fld_53_2 from gmis_mo_53 where fld_53_1=fld_20_1)";
		h_fstr += " and "+h_field+" like '%"+guangye.GetControlValue(key)+"%'";
	}

	list.SqlStr = "select  '" + StringUtility.StringToBase64("view") + "'," + mid + ",mocode,fld_20_2,fld_20_1,'' btnstr from gmis_mo_20 where 1=1 "+h_fstr+" order by fld_20_2 desc";
...
{	
	...
	Response.Redirect("list_20.aspx?aid=" + StringUtility.StringToBase64("list") + "&mid=" + mid + "&navindex=0");
}
</script>
...
<G:ListTable ID="list" Rows="20" IsProPage=true runat="server">
	...
	<G:NavStyle5 ID="NavStyle" PageUrl="list_20.aspx" runat="server"></G:NavStyle5>
	</G:ListTable> 
<!--动态生成html,结束-->
</form>
</body>
